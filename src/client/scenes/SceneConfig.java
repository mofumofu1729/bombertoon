...
public class SceneConfig extends BasicGameState {
    ...
    public void update(GameContainer arg0, StateBasedGame arg1, int arg2) throws SlickException {
        if (arg0.getInput().isMousePressed(Input.MOUSE_LEFT_BUTTON)
                && (arg0.getInput().getAbsoluteMouseX() > 456)
                && (arg0.getInput().getAbsoluteMouseX() < 660)
                && (arg0.getInput().getAbsoluteMouseY() > 425)
                && (arg0.getInput().getAbsoluteMouseY() < 508)
                && ((hostNameBox.getText().equals("") == false)
                        || (portNumber.getText().equals("") == false))) {
