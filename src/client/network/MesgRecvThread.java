                    ...
                    switch (command[0]) {
                        case "FIELD":
                            ...
                            if (command[3].equals("BOMB")) {
                                field = new FieldClient(x, y, true, Status.NOTHING,
                                        strToColor(command[4]));
                            } else {
                                field = new FieldClient(x, y, false, strToStatus(command[3]),
                                        strToColor(command[4]));
                            }
                        ...
                        case "RESULT": // 結果を送る
                            ...
                            switch (command[1]) {
                                case "PLAYERNUM":
                                    ...
                                    break;
                                case "FIELD":
                                    tc.getScore().painted[Integer.parseInt(command[2])] =
                                    ...
                                    break;
                                case "KILL":
                                    tc.getScore().kill[Integer.parseInt(command[2])] =
                                            Integer.parseInt(command[3]);
                                    break;
                                case "DEATH":
                                    tc.getScore().death[Integer.parseInt(command[2])] =
                                            Integer.parseInt(command[3]);
                                    break;
                            }
                            break;
